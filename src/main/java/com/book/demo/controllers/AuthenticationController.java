...
public class AuthenticationController {
    ...
    public ResponseEntity<Object> signUpAccount(@RequestBody ClientRequestDTO clientRequestDTO) {
        String token = authenticationService.signUp(clientRequestDTO);
    ...
    @PatchMapping(value = "/forget-password", produces = { "application/json" })
    public ResponseEntity<Object> forgetPassword(@RequestParam String email, @RequestBody ClientPatchPasswordDTO clientPatchPasswordDTO) {
